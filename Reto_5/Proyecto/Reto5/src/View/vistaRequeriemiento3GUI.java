 ...
 */
public class vistaRequeriemiento3GUI extends javax.swing.JFrame {
     ...
     */
    public vistaRequeriemiento3GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaRequeriemiento3GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaRequeriemiento3GUI().setVisible(true);
            }
        });
    }
